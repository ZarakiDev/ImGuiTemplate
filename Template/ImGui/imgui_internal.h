...
static inline bool      ImCharIsBlankA(char16_t c)          { return c == u' ' || c == u'\t'; }
...
IMGUI_API int           ImTextCharFromUtf16(unsigned int* out_char, const char16_t* in_text, const char16_t* in_text_end);      // read one character. return input UTF-16 bytes count
