...
struct ImFont
{
    ...
    IMGUI_API void              RenderOutlinedText(ImDrawList* draw_list, float size, const ImVec2& pos, ImU32 col, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false, float outline_thickness = 1.0f) const;
